...
write.csv(three_sym_not_in_db, "~\\GitHub\\child-verb-matching-study\\Output\\symmetricals\\child\\three\\three_sym_not_in_db_new.csv")
...
#we select only the symmetricals we are interested in. 
...
write.csv(verb_pairs_for_three_child_sheet_sym, "~\\GitHub\\child-verb-matching-study\\Output\\symmetricals\\child\\verb_pairs_for_three_child_sheet_sym_new.csv")
...
write.csv(exclusion_three_info_sym_final, "~\\GitHub\\child-verb-matching-study\\Output\\symmetricals\\child\\exclusion_three_info_sym_final_new.csv")
...
write.csv(corpra_tokens_three_sym,"~\\GitHub\\child-verb-matching-study\\Output\\symmetricals\\child\\tokens-from-each-corpus-three-sym-new.csv")
...
write.csv(token_freq_per_child_three_sym_final, "~\\GitHub\\child-verb-matching-study\\Output\\symmetricals\\child\\token-freq-per-child-three-sym-final-new.csv")
...
write.csv(four_sym_not_in_db, "~\\GitHub\\child-verb-matching-study\\Output\\symmetricals\\child\\four_sym_not_in_db_new.csv")

length(four_sym_filtered_pos_df$target_child_id) #504
length(unique(four_sym_filtered_pos_df$target_child_id)) #55
# brb #
#making df of unique ids in three year olds
ids_for_four_sym <- as.data.frame(unique(four_sym_filtered_pos_df$target_child_id))
names(ids_for_four_sym)[names(ids_for_four_sym) == "unique(four_sym_filtered_pos_df$target_child_id)"] <- "target_child_id"
length(unique(ids_for_four_sym$target_child_id)) #55 ids
...
four_many_ids_sym <- ids_for_four_sym %>% slice(rep(1:n(), each = 90))
length(four_many_ids_sym$target_child_id) #4950 (55 * 90)

#generate 41 (for each id) instances of sym_words 
...
length(four_counts_pasted_targetid_uttid_stem_separate_sym$target_child_id) #266 (THIS SHOULD ADD UP TO THE LENGTH OF EXCLUSION FOR FINAL AND THE SUM OF NO ZEROS DF) it doesn't because this includes words
#not in the top 12. OKAY FIXED
#length(unique(four_counts_pasted_targetid_uttid_stem_separate2$target_child_id))
length(unique(four_counts_pasted_targetid_uttid_stem_separate_sym$target_child_id)) #40
...
length(four_full_sym$target_child_id) #5065
...
length(unique(four_full_sym$form)) #91
length(unique(four_full_sym$target_child_id)) #55
length(four_full_sym$form) #5065
...
length(filter_by_stem_four_sym$target_child_id) #2748
...
write.csv(four_child_all_stems_per_child_no_zeros_sym, "~\\GitHub\\child-verb-matching-study\\Output\\symmetricals\\child\\four\\four_child_all_stems_per_child_no_zeros_sym-new.csv")
length(unique(four_child_all_stems_per_child_no_zeros_sym$target_child_id)) #40 total children represented. 
sum(four_child_all_stems_per_child_no_zeros_sym$tokens) #266
#eliminating the zeros worked!
verb_pairs_for_four_child_sheet_sym <- four_child_all_stems_per_child_no_zeros_sym %>% dplyr::group_by(stem) %>%
  dplyr::summarize(tokens = sum(tokens), num_chi = length(unique(target_child_id)))
write.csv(verb_pairs_for_four_child_sheet_sym, "~\\GitHub\\child-verb-matching-study\\Output\\symmetricals\\child\\four\\verb_pairs_for_four_child_sheet_sym-new.csv")
length(unique(four_child_all_stems_per_child_no_zeros_sym$target_child_id)) #40
sum(four_child_all_stems_per_child_no_zeros_sym$tokens) #266
...
#good this is the one we need to pull frames!
length(exclusion_four_info_sym_final$target_child_id) #267
...
write.csv(exclusion_four_info_sym_final, "~\\GitHub\\child-verb-matching-study\\Output\\symmetricals\\child\\four\\exclusion_four_info_sym_final-new.csv")
#check the corpra in this df
unique(exclusion_four_info_sym_final$corpus_name)

length(unique(exclusion_four_info_sym_final$target_child_id)) #40
length(unique(filter_by_stem_four_sym$target_child_id)) #55
...
write.csv(token_freq_per_child_four_sym_final, "~\\GitHub\\child-verb-matching-study\\Output\\symmetricals\\child\\four\\token-freq-per-child-four-sym-final-new.csv")
...
sum(combined_three_four_verb_pair_tokens_sym$tokens) #576
...
write.csv(combined_three_four_verb_pair_tokens_summed_sym, "~\\GitHub\\child-verb-matching-study\\Output\\symmetricals\\child\\combined\\combined-three-four-verb-pair-tokens-summed-sym-new.csv")
sum(combined_three_four_verb_pair_tokens_summed_sym$tokens) #576
...
write.csv(combined_corpra_tokens_sym_final, "~\\GitHub\\child-verb-matching-study\\Output\\symmetricals\\child\\combined\\combined-corpra-tokens-sym-final-new.csv")
...
write.csv(combined_num_of_children_in_each_corpus_sym_final, "~\\GitHub\\child-verb-matching-study\\Output\\symmetricals\\child\\combined\\combined-num-of-children-in-each-corpus-sym-final-new.csv")
sum(combined_num_of_children_in_each_corpus_sym_final$num_chi) #71

#combined sym exclusion info
combined_exclusion_syms <- rbind(exclusion_three_info_sym_final, exclusion_four_info_sym_final)
write.csv(combined_num_of_children_in_each_corpus_sym_final, "~\\GitHub\\child-verb-matching-study\\Output\\symmetricals\\child\\combined\\combined_num_of_children_in_each_corpus_sym_final-new.csv")
length(combined_exclusion_syms$target_child_id) #576
...
#saving
write.csv(three_foils_not_in_db, "~\\GitHub\\child-verb-matching-study\\Output\\foils\\child\\three\\three_foils_not_in_db-new.csv")
...
verb_pairs_for_three_child_sheet_foils <- three_child_all_stems_per_child_no_zeros_foils %>% dplyr::group_by(stem) %>%
  dplyr::summarize(tokens = sum(tokens), num_chi = length(unique(target_child_id)))
write.csv(verb_pairs_for_three_child_sheet_foils, "~\\GitHub\\child-verb-matching-study\\Output\\foils\\child\\three\\verb_pairs_for_three_child_sheet_foils-new.csv")
length(unique(three_child_all_stems_per_child_no_zeros_foils$target_child_id)) #73
...
write.csv(exclusion_three_info_foils_final, "~\\GitHub\\child-verb-matching-study\\Output\\foils\\child\\three\\exclusion_three_info_foils_final-new.csv")
#check the corpra in this df
...
write.csv(token_freq_per_child_three_foils_final, "~\\GitHub\\child-verb-matching-study\\Output\\foils\\child\\three\\token-freq-per-child-three-foils-final-new.csv")
...
write.csv(four_foils_not_in_db, "~\\GitHub\\child-verb-matching-study\\Output\\foils\\child\\four\\four_foils_not_in_db-new.csv")
...
#USE THIS TO GET THE FRAMES! AND FIND DUPLICATES!
#length(unique(four_counts_pasted_targetid_uttid_stem_separate2$target_child_id))
length(four_counts_pasted_targetid_uttid_stem_separate_foils$target_child_id) #1129 (THIS SHOULD ADD UP TO THE LENGTH OF EXCLUSION FOR FINAL AND THE SUM OF NO ZEROS DF) it doesn't because this includes words
...
length(four_full_foils$target_child_id) #7654
...
length(unique(four_full_foils$form)) #105
length(unique(four_full_foils$target_child_id)) #67
length(four_full_foils$form) #7654
...
length(filter_by_stem_four_foils$target_child_id) #7654
...
sum(four_child_all_stems_per_child_foils$tokens) #1129
#test2 <- filter_by_stem %>% group_by(stem) %>%
#summarize(num_chi = )
write.csv(four_child_all_stems_per_child_foils, "~\\GitHub\\child-verb-matching-study\\Output\\foils\\child\\four\\four_child_all_stems_per_child_foils-new.csv")
...
verb_pairs_for_four_child_sheet_foils <- four_child_all_stems_per_child_no_zeros_foils %>% dplyr::group_by(stem) %>%
  dplyr::summarize(tokens = sum(tokens), num_chi = length(unique(target_child_id)))
write.csv(verb_pairs_for_four_child_sheet_foils, "~\\GitHub\\child-verb-matching-study\\Output\\foils\\child\\four\\verb_pairs_for_four_child_sheet_foils-new.csv")
...
length(exclusion_four_info_foils_final$target_child_id) #1129
write.csv(exclusion_four_info_foils_final, "~\\GitHub\\child-verb-matching-study\\Output\\foils\\child\\four\\exclusion_four_info_foils_final-new.csv")
#check the corpra in this df
...
corpra_tokens_four_foils <- exclusion_four_info_foils_final %>% dplyr::group_by(corpus_name) %>%
  dplyr::summarize(tokens = length(corpus_name))
write.csv(corpra_tokens_four_foils,"~\\GitHub\\child-verb-matching-study\\Output\\foils\\child\\four\\tokens-from-each-corpus-four-foils-new.csv")
...
write.csv(token_freq_per_child_four_foils_final, "~\\GitHub\\child-verb-matching-study\\Output\\foils\\child\\four\\token_freq_per_child_four_foils_final-new.csv")
...
combined_three_four_verb_pair_tokens_summed_foils <- combined_three_four_verb_pair_tokens_foils %>% dplyr::group_by(stem) %>%
  dplyr::summarize(tokens = sum(tokens), num_chi = sum(num_chi))
sum(combined_three_four_verb_pair_tokens_summed_foils$tokens) #2844
write.csv(combined_three_four_verb_pair_tokens_summed_foils, "~\\GitHub\\child-verb-matching-study\\Output\\foils\\child\\combined\\combined_three_four_verb_pair_tokens_summed_foils-new.csv")
...
combined_corpra_tokens_foils_final <- combined_corpra_tokens_foils %>% dplyr::group_by(corpus_name) %>%
  dplyr::summarize(tokens = sum(tokens))
write.csv(combined_corpra_tokens_foils_final, "~\\GitHub\\child-verb-matching-study\\Output\\foils\\child\\combined\\combined_corpra_tokens_foils_final-new.csv")
...
combined_num_of_children_in_each_corpus_foils_final <- combined_num_of_children_in_each_corpus_foils %>% dplyr::group_by(corpus_name) %>%
  dplyr::summarize(num_chi = sum(num_chi))
write.csv(combined_num_of_children_in_each_corpus_foils_final, "~\\GitHub\\child-verb-matching-study\\Output\\foils\\child\\combined\\combined_num_of_children_in_each_corpus_foils_final-new.csv")
...
write.csv(combined_num_of_children_in_foils_redux_unique, "~\\GitHub\\child-verb-matching-study\\Output\\foils\\child\\combined\\combined_num_of_children_in_foils_redux_unique.csv")
...
length(unique(combined_exclusion_foils$target_child_id)) #natches up with "combined_num_of_children_in_foils"
...
length(unique(combined_exclusion_foil_sym$target_child_id)) #126 unique children in both sym and foil
length(combined_exclusion_foil_sym$target_child_id) #3494
write.csv(combined_exclusion_foil_sym, "~\\GitHub\\child-verb-matching-study\\Output\\combined_foil_sym\\combined_exclusion_foil_sym.csv")

#corpra counts
combined_corpora_tokens_sym_and_foil <- combined_exclusion_foil_sym %>% dplyr::group_by(corpus_name) %>%
  dplyr::summarize(tokens = length(corpus_name))
write.csv(combined_corpora_tokens_sym_and_foil, "~\\GitHub\\child-verb-matching-study\\Output\\combined_foil_sym\\combined_corpora_tokens_sym_and_foil.csv")
sum(combined_corpora_tokens_sym_and_foil$tokens)# 3494
...
length(syms_in_foils$target_child_id) #650, which is all of the symmetricals.
length(unique(syms_in_foils$target_child_id)) #74 syms and foil contribution
...
length(unique(foils_not_in_syms$target_child_id)) #52 pure foil kids

length(unique(exclusion_four_info_foils_final$target_child_id)) #53
length(unique(exclusion_three_info_foils_final$target_child_id)) #73

length(unique(exclusion_three_info_sym_final$target_child_id)) #33 syms
length(unique(exclusion_four_info_sym_final$target_child_id)) #41 syms
...
length(unique(combined_exclusion_foil_sym$corpus_name)) #25
